...
SWIFT_CLASS("_TtC12GiphyCoreSDK12GPHAdSession")
@interface GPHAdSession : NSObject
...
@property (nonatomic, readonly, strong) GPHAdSession * _Nullable adSession;
- (void)createAndAddSession;
@end
...
@property (nonatomic, readonly, copy) NSString * _Nullable javascriptResourceUrl;
@property (nonatomic, readonly, copy) NSString * _Nullable vendorKey;
@property (nonatomic, readonly, copy) NSString * _Nullable verificationParameters;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (void)trackWithMedia:(GPHMedia * _Nonnull)media userID:(NSString * _Nonnull)userID actionType:(enum GPHActionType)actionType;
+ (void)reset;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
