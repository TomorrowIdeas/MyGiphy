 ...
 */
@interface OMIDGiphyAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDGiphyPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDGiphyPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDGiphyVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
