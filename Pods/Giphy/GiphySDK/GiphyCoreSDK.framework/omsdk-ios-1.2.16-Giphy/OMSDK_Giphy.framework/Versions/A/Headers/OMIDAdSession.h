 ...
 */
@interface OMIDGiphyAdSession : NSObject

/*!
 * @abstract The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDGiphyAdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDGiphyAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDGiphyAdSessionContext *)context
