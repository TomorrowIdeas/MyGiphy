...
typedef SWIFT_ENUM(NSInteger, GPHContentType, closed) {
  GPHContentTypeGifs = 0,
  GPHContentTypeStickers = 1,
  GPHContentTypeText = 2,
  GPHContentTypeEmoji = 3,
};

enum GPHContentTypeButtonStyle : NSInteger;
enum GPHGifButtonColor : NSInteger;

SWIFT_CLASS("_TtC10GiphyUISDK20GPHContentTypeButton")
@interface GPHContentTypeButton : UIButton
@property (nonatomic) enum GPHContentTypeButtonStyle style;
@property (nonatomic) enum GPHGifButtonColor color;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
@end

typedef SWIFT_ENUM(NSInteger, GPHContentTypeButtonStyle, closed) {
  GPHContentTypeButtonStyleStickers = 0,
  GPHContentTypeButtonStyleEmoji = 1,
  GPHContentTypeButtonStyleText = 2,
  GPHContentTypeButtonStyleStickersOutline = 3,
  GPHContentTypeButtonStyleEmojiOutline = 4,
  GPHContentTypeButtonStyleTextOutline = 5,
};

typedef SWIFT_ENUM(NSInteger, GPHFileExtension, closed) {
  GPHFileExtensionMp4 = 0,
  GPHFileExtensionGif = 1,
  GPHFileExtensionWebp = 2,
};

enum GPHGifButtonStyle : NSInteger;

SWIFT_CLASS("_TtC10GiphyUISDK12GPHGifButton")
@interface GPHGifButton : UIButton
@property (nonatomic) enum GPHGifButtonStyle style;
@property (nonatomic) enum GPHGifButtonColor color;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
- (void)layoutSubviews;
...
typedef SWIFT_ENUM(NSInteger, GPHGifButtonColor, closed) {
...
typedef SWIFT_ENUM(NSInteger, GPHGifButtonStyle, closed) {
  GPHGifButtonStyleRectangle = 0,
  GPHGifButtonStyleRectangleRounded = 1,
  GPHGifButtonStyleRectangleOutline = 2,
  GPHGifButtonStyleRectangleOutlineRounded = 3,
  GPHGifButtonStyleSquare = 4,
  GPHGifButtonStyleSquareRounded = 5,
  GPHGifButtonStyleSquareOutline = 6,
  GPHGifButtonStyleSquareOutlineRounded = 7,
  GPHGifButtonStyleText = 8,
};

enum GPHGiphyButtonStyle : NSInteger;

SWIFT_CLASS("_TtC10GiphyUISDK14GPHGiphyButton")
@interface GPHGiphyButton : UIButton
@property (nonatomic) enum GPHGiphyButtonStyle style;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
@end

typedef SWIFT_ENUM(NSInteger, GPHGiphyButtonStyle, closed) {
  GPHGiphyButtonStyleLogo = 0,
  GPHGiphyButtonStyleLogoRounded = 1,
  GPHGiphyButtonStyleIconSquare = 2,
  GPHGiphyButtonStyleIconSquareRounded = 3,
  GPHGiphyButtonStyleIconColor = 4,
  GPHGiphyButtonStyleIconBlack = 5,
  GPHGiphyButtonStyleIconWhite = 6,
};
...
- (void)didSelectMediaWithMedia:(GPHMedia * _Nonnull)media;
@end

typedef SWIFT_ENUM(NSInteger, GPHGridLayout, closed) {
  GPHGridLayoutWaterfall = 0,
  GPHGridLayoutCarousel = 1,
};
...
@interface GPHMedia (SWIFT_EXTENSION(GiphyUISDK))
@property (nonatomic, readonly) NSInteger diffId;
+ (BOOL)compareContent:(GPHMedia * _Nonnull)a :(GPHMedia * _Nonnull)b SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)setMediaWithID:(NSString * _Nonnull)id rendition:(enum GPHRenditionType)rendition;
@end
...
typedef SWIFT_ENUM(NSInteger, GPHTheme, closed) {
  GPHThemeDark = 0,
  GPHThemeLight = 1,
};
...
@property (nonatomic) enum GPHTheme theme;
@property (nonatomic) enum GPHGridLayout layout;
...
@property (nonatomic) BOOL showCheckeredBackground;
...
@interface GiphyGridController (SWIFT_EXTENSION(GiphyUISDK))
...
SWIFT_CLASS("_TtC10GiphyUISDK10GiphyUISDK")
@interface GiphyUISDK : NSObject
...
@property (nonatomic) BOOL shouldLocalizeSearch;
/// Set the layout to be <code>.waterfall</code> (vertical) or <code>.carousel</code> (horizontal).
@property (nonatomic) enum GPHGridLayout layout;
